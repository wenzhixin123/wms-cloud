...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/wms-sys-service/src/main/java");
        gc.setAuthor("wenzhixin");
        ...
        dsc.setUrl("jdbc:mysql://10.211.55.5:3306/wms?useUnicode=true&useSSL=false&characterEncoding=utf8");
